...
(function (global, factory) {
      ...
      init()
      {
          ...
          this._zoom.filter((event) => {
              ...
              if (event.type === "wheel") {
                  ...
                  const transform$1 = transform(this);
   ...
   * @returns {number}
   */
  function measureText(text, fontFamily, fontSize, fontWeight = 400)
  {
  ...
  class Text
  {
      ...
      createLabels(parent, datum)
      {
          ...
          // Labels along arc
          if (this.isLabelAlongArc(datum)) {
              const parentId = select(parent.node().parentNode).attr("id");
              ...
              this.setFontSize(parent, datum, numberOfLines);
          }
      ...
      getIndexOfSizingLine(parent, data, numberOfLines, labelFontSize) {
          ...
          if (data.depth === 0) {
              ...
              parent.selectAll("text")
                  .each(function (d, i) {
                      textLength = that.getTextLength(select(this));
      ...
      transformText(parent, data, labelFontSize) {
          ...
          textElements.each(function (ignore, i) {
              ...
              select(this).attr("dy", (labelFontSize / 3) + "px");

              // Name of center person should not be rotated in any way
              if (data.depth === 0) {
                  select(this).attr("transform", "translate(0 " + (labelFontSize * offsetRotate) + ")");
              }
       ...
       */
       center()
       {
           this.svg
               .transition()
               .duration(750)
               .call(this.svg.zoom.get().transform, identity);
       }
